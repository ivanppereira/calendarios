    ...
    return (
      <div className="login-shell">
        <div className="login-card">
          ...
          <p>Entre com sua conta Google para criar, editar, comentar ou visualizar calendários.</p>
          <button className="btn btn-primary btn-login" onClick={auth.entrarComGoogle}>
          ...
          {auth.erro && <p className="erro-msg-modal">{auth.erro}</p>}
        </div>
      </div>
    );
  }
